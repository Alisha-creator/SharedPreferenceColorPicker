package alisha.digipodium.sharedpreferencecolorpicker;
...
public class FirstFragment extends Fragment implements SeekBar.OnSeekBarChangeListener{
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        btnSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.apply();
                Snackbar.make(btnSet,"Saved settings in memory", BaseTransientBottomBar.LENGTH_LONG).show();
            }
        });
        ...
        btnClear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Snackbar.make(btnClear,"Cleared Settings",BaseTransientBottomBar.LENGTH_LONG).show();
    ...
    public void onResume() {
        ...
        int green = appPref.getInt("green",100);
        int blue = appPref.getInt("blue",100);
